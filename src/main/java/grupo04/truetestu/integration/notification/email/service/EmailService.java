package grupo04.truetestu.integration.notification.email.service;
...
public void sendMail(Mail mail, String templateName) throws MessagingException {
    ...
    //Configurar el contexto de Tymeleaf con los datos del modelo
    Context context = new Context();
    context.setVariables(mail.getModel());

    //Procesar las plantillas utilizando Tymeleaf
