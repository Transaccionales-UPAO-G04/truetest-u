...
import grupo04.truetestu.security.JWTConfigurer;
import grupo04.truetestu.security.JWTFilter;
import grupo04.truetestu.security.JwtAuthenticationEntryPoint;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(antMatcher("/carreras/recent")).permitAll()
